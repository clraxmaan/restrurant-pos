...
<body>
  <!-- Sidenav --><!-- For more projects: Visit dopedevelopers.com/category/source-codes/  -->
  <?php
  ...
  <div class="main-content">
    ...
    <div class="container-fluid mt--8">
      <!-- Table -->
      <div class="row">
        <div class="col"><!-- For more projects: Visit dopedevelopers.com/category/source-codes/  -->
          <div class="card shadow">
            ...
            <div class="table-responsive">
              <table class="table align-items-center table-flush">
                ...
                </thead><!-- For more projects: Visit dopedevelopers.com/category/source-codes/  -->
                <tbody>
                  <?php
