...
if (isset($_POST['addProduct'])) {
	//Visit dopedevelopers.com/category/source-codes/ for more projects
...
<body>
  ...
  ?>
  <!-- Main content --><!-- For more projects: Visit dopedevelopers.com/category/source-codes/  -->
  <div class="main-content">
    ...
    </div><!-- For more projects: Visit dopedevelopers.com/category/source-codes/  -->
    <!-- Page content -->
          ...
          <div class="card shadow">
            ...
            <div class="card-body">
              <form method="POST" enctype="multipart/form-data">
                ...
                <hr><!-- For more projects: Visit dopedevelopers.com/category/source-codes/  -->
                <div class="form-row">
                  <div class="col-md-6">
                ...
                <br><!-- For more projects: Visit dopedevelopers.com/category/source-codes/  -->
                <div class="form-row">
                  <div class="col-md-6">
...
<!-- For more projects: Visit dopedevelopers.com/category/source-codes/  -->
</html>