        ...
        <div class="header-body">
          ...
          <div class="row">
            ...
            <div class="col-xl-4 col-lg-6">
              ...
              </a><!-- For more projects: Visit dopedevelopers.com/category/source-codes/  -->
            </div>
            <div class="col-xl-4 col-lg-6">
                ...
                <div class="card card-stats mb-4 mb-xl-0">
                  <div class="card-body">
                    <div class="row">
                      ...
                      </div><!-- For more projects: dopedevelopers.com/category/source-codes/  -->
                    </div>
                  </div>
                </div>
              </a>
            ...
            <div class="table-responsive">
              ...
              <table class="table align-items-center table-flush">
                <thead class="thead-light">
                  <tr><!-- For more projects: dopedevelopers.com/category/source-codes/  -->
...
<!-- For more projects: dopedevelopers.com/category/source-codes/  -->
</html>