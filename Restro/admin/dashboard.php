          ...
          <div class="card shadow">
            <div class="card-header border-0">
              <div class="row align-items-center">
                ...
                <div class="col text-right">
                  <a href="orders_reports.php" class="btn btn-sm btn-info">See all</a>
                </div>
                <div class="col text-left">
                  <a href="orders_reports.php" class="btn btn-sm btn-primary">print</a>
                </div>
              </div>
            </div>
            <div class="table-responsive">
              ...
              <table class="table align-items-center table-flush">
                ...
                <tbody>
                  <?php
                  $ret = "SELECT * FROM  rpos_orders ORDER BY `rpos_orders`.`created_at` DESC LIMIT 10 ";
